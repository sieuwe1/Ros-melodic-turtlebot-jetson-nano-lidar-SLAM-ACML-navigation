...
echo_and_run cd "/home/jetson/turtlebot_ws/src/kobuki_desktop/kobuki_dashboard"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/jetson/turtlebot_ws/build/kobuki_desktop/kobuki_dashboard" \
    install \
    --root="${DESTDIR-/}" \
