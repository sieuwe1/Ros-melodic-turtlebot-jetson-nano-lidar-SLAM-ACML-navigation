...
// reducing the odds to have name collisions with Windows.h 
  ...
  #undef OFF
#endif
#if defined(_WIN32) && defined(RECHARGE)
  #undef RECHARGE
#endif
  ...
  #undef ERROR
#endif
#if defined(_WIN32) && defined(CLEANINGSTART)
  #undef CLEANINGSTART
#endif
#if defined(_WIN32) && defined(CLEANINGEND)
  #undef CLEANINGEND
#endif
...
bool operator==(const ::kobuki_msgs::Sound_<ContainerAllocator1> & lhs, const ::kobuki_msgs::Sound_<ContainerAllocator2> & rhs)
{
