...
"""autogenerated by genpy from kobuki_msgs/AutoDockingActionFeedback.msg. Do not edit."""
import sys
...
class AutoDockingActionFeedback(genpy.Message):
  ...
  _type = "kobuki_msgs/AutoDockingActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','kobuki_msgs/AutoDockingFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = kobuki_msgs.msg.AutoDockingFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = kobuki_msgs.msg.AutoDockingFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.feedback.text = str[start:end].decode('utf-8')
      else:
