...
"""autogenerated by genpy from kobuki_msgs/AutoDockingActionResult.msg. Do not edit."""
import sys
...
class AutoDockingActionResult(genpy.Message):
  ...
  _type = "kobuki_msgs/AutoDockingActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','kobuki_msgs/AutoDockingResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = kobuki_msgs.msg.AutoDockingResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = kobuki_msgs.msg.AutoDockingResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.result.text = str[start:end].decode('utf-8')
      else:
